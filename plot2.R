...
#this is a plot of V3 variable regarding the order of collection of data. For that reason the
#x axis is the index number of observation. Because of the methodology of sampling, it was safe 
#to draw the x axis in this simple way. If the sampling were uneven, i.e. not same number of
#observations were collected for each day, we would have to first find the index of the first 
#observation for a given day.
